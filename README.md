...
How operational and customer data can be turned into useful business information and decisions
...
Business Problem --> Understand the Data --> Prepare the Data --> Select KPIs --> Analyze Patterns --> Test Explanations --> Develop Insights --> Recommend Action --> Measure the Outcome
